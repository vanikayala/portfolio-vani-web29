...
const technologies = () => {
  return (
    <section>
      <div className="md:container m-auto md:mt-12 py-16">
        <h2 className="md:text-3xl pt-8 text-center text-transparent bg-clip-text bg-gradient-to-br from-yellow-200 via-orange-400 to-orange-800 font-bold">Technologies</h2>
